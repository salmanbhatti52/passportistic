...
//
//     final arrivalDetailsModels = arrivalDetailsModelsFromJson(jsonString);

import 'dart:convert';

ArrivalDetailsModels arrivalDetailsModelsFromJson(String str) => ArrivalDetailsModels.fromJson(json.decode(str));

String arrivalDetailsModelsToJson(ArrivalDetailsModels data) => json.encode(data.toJson());

class ArrivalDetailsModels {
    String? status;
    
    List<Datum>? data;

    ArrivalDetailsModels({
        this.status,
        this.data,
    });

    factory ArrivalDetailsModels.fromJson(Map<String, dynamic> json) => ArrivalDetailsModels(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        stampsArriveDepart: stampsArriveDepartValues.map[json["stamps_arrive_depart"]],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "stamps_arrive_depart": stampsArriveDepartValues.reverse[stampsArriveDepart],
...
final isCancelledValues = EnumValues({
    "False": IsCancelled.FALSE
});

enum StampsArriveDepart {
    ARRIVE,
    DEPART
}

final stampsArriveDepartValues = EnumValues({
    "Arrive": StampsArriveDepart.ARRIVE,
    "Depart": StampsArriveDepart.DEPART
});
