...
//
//     final updateTravelDiaryModels = updateTravelDiaryModelsFromJson(jsonString);

import 'dart:convert';

UpdateTravelDiaryModels updateTravelDiaryModelsFromJson(String str) =>
    UpdateTravelDiaryModels.fromJson(json.decode(str));

String updateTravelDiaryModelsToJson(UpdateTravelDiaryModels data) =>
    json.encode(data.toJson());

class UpdateTravelDiaryModels {
  String? status;
  Data? data;

  UpdateTravelDiaryModels({
    this.status,
    this.data,
  });

  factory UpdateTravelDiaryModels.fromJson(Map<String, dynamic> json) =>
      UpdateTravelDiaryModels(
        status: json["status"],
