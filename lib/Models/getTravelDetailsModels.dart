...
GetTravelDetailsModels getTravelDetailsModelsFromJson(String str) => GetTravelDetailsModels.fromJson(json.decode(str));

String getTravelDetailsModelsToJson(GetTravelDetailsModels data) => json.encode(data.toJson());
...
class GetTravelDetailsModels {
    ...
    factory GetTravelDetailsModels.fromJson(Map<String, dynamic> json) => GetTravelDetailsModels(
        status: json["status"],
